                ...
                <ul className="flex flex-row flex-wrap gap-4 sm:gap-6">
                  {seriesPartners.map((item, index) => (
                    <li key={index} className="flex flex-col items-center gap-1">
                      ...
                      <div className="rounded-2xl flex items-center mb-4 justify-center bg-violet-600/50 w-full h-full p-2 sm:p-4">
                        <img 
                          src={item.icon} 
                          width={150} 
                          height={150} 
          ...
          >
            <ul className="flex flex-row flex-nowrap gap-6">
              {SlidingPartnersRight.map((item, index) => (
                <li key={index} className="flex flex-col items-center gap-1 w-[150px]">
                  <div className="rounded-2xl flex items-center mb-4 justify-center bg-violet-600/50 w-full h-full p-2 sm:p-4">
                    <img 
                      src={item.icon} 
                      width={150} 
